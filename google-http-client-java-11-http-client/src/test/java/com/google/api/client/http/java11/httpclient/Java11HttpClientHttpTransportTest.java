...
/**
 * Tests {@link Java11HttpClientHttpTransport}.
 *
 * @author Yaniv Inbar
 */
@Ignore
public class Java11HttpClientHttpTransportTest {
  ...
  public void testApacheHttpTransport() {
    Java11HttpClientHttpTransport transport = new Java11HttpClientHttpTransport();
  ...
  public void testApacheHttpTransportWithParam() {
    Java11HttpClientHttpTransport transport = new Java11HttpClientHttpTransport(HttpClient.newHttpClient(), true);
    checkHttpTransport(transport);
  ...
  public void testNewDefaultHttpClient() {
    HttpClient client = Java11HttpClientHttpTransport.newDefaultHttpClient();
    checkHttpClient(client);
  }

  private void checkHttpTransport(Java11HttpClientHttpTransport transport) {
...
//          }
//        };
    Java11HttpClientHttpTransport transport = new Java11HttpClientHttpTransport(HttpClient.newHttpClient());
  ...
  private void subtestUnsupportedRequestsWithContent(Java11HttpClientHttpRequest request, String method)
      throws IOException {
    try {
      execute(request);
  ...
  private void execute(Java11HttpClientHttpRequest request) throws IOException {
...
//    HttpClient client = HttpClients.custom().setRequestExecutor(requestExecutor).build();
    Java11HttpClientHttpTransport transport = new Java11HttpClientHttpTransport(HttpClient.newHttpClient());
    Java11HttpClientHttpRequest request = transport.buildRequest("GET", "https://google.com");
...
//            .build();
  ...
  public void testConnectTimeout() {
    ...
    HttpTransport httpTransport = new Java11HttpClientHttpTransport();
  ...
  public void testNormalizedUrl() throws IOException {
    ...
    try (FakeServer server = new FakeServer(handler)) {
      HttpTransport transport = new Java11HttpClientHttpTransport();
